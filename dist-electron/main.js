...
import In, { ipcMain as me, app as nt, shell as dl, BrowserWindow as fr, dialog as Km } from "electron";
...
kn.CancellationError = Ac;
var ot = {}, Rc = { exports: {} }, Da = { exports: {} }, jo, Lp;
function sb() {
  if (Lp) return jo;
  Lp = 1;
...
var ja = { exports: {} }, Lo, qp;
function cb() {
  return qp || (qp = 1, Lo = (e, t = process.argv) => {
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Rc.exports = ob() : Rc.exports = ub();
var Qm = Rc.exports, Jr = {};
...
Ls.githubUrl = $b;
Ls.getS3LikeProviderBaseUrl = Sb;
...
const Zb = lt.fromPromise, { makeDir: ex, makeDirSync: Mo } = wl, qo = Zb(ex);
var Wt = {
  mkdirs: qo,
  mkdirsSync: Mo,
  // alias
...
function cx(e, t, n, r, i) {
  ax.callbackify(sx)(e, t, r, (a, s) => {
    ...
    return o.isDirectory() && _l(e, t) ? i(new Error(Ms(e, t, n))) : i(null, { srcStat: o, destStat: c });
  });
}
function lx(e, t, n, r) {
...
function hh(e, t, n, r, i) {
  ...
  Vr.stat(s, { bigint: !0 }, (o, c) => o ? o.code === "ENOENT" ? i() : i(o) : da(t, c) ? i(new Error(Ms(e, n, r))) : hh(e, t, s, r, i));
}
function vh(e, t, n, r) {
...
function yh(e, t, n, r, i) {
  mt.copyFile(t, n, (a) => a ? i(a) : r.preserveTimestamps ? gx(e.mode, t, n, i) : qs(n, e.mode, i));
}
function gx(e, t, n, r) {
...
const Jx = lt.fromPromise, Rh = hr, Ph = pe, Oh = Wt, Nh = Bs, rd = Jx(async function(t) {
  let n;
  try {
...
const zs = lt, { stringify: zh, stripBom: Hh } = Tl;
async function Pw(e, t = {}) {
  typeof t == "string" && (t = { encoding: t });
  const n = t.fs || Gr, r = "throws" in t ? t.throws : !0;
  let i = await zs.fromCallback(n.readFile)(e, t);
  i = Hh(i);
  let a;
  try {
...
async function Cw(e, t, n = {}) {
  ...
  await zs.fromCallback(r.writeFile)(e, i, n);
}
const Iw = zs.fromPromise(Cw);
function kw(e, t, n = {}) {
  const r = n.fs || Gr, i = zh(t, n);
...
var Jw = ct;
const Qw = ut, Nc = pe, Zw = $l.copy, Wh = Bs.remove, e_ = Wt.mkdirp, t_ = vr.pathExists, dd = Qr;
function n_(e, t, n, r) {
  ...
  dd.checkPaths(e, t, "move", n, (a, s) => {
    ...
    dd.checkParentPaths(e, o, t, "move", (l) => {
      ...
      e_(Nc.dirname(t), (u) => u ? r(u) : fd(e, t, i, c, r));
    });
  });
}
function r_(e) {
...
function fd(e, t, n, r, i) {
  ...
  if (n)
    return Wh(t, (a) => a ? i(a) : Bo(e, t, n, i));
  t_(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : Bo(e, t, n, i));
}
function Bo(e, t, n, r) {
...
var a_ = n_;
const Kh = ut, Cc = pe, s_ = $l.copySync, Yh = Bs.removeSync, o_ = Wt.mkdirpSync, md = Qr;
function c_(e, t, n) {
  n = n || {};
  const r = n.overwrite || n.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = md.checkPathsSync(e, t, "move", n);
  return md.checkParentPathsSync(e, i, t, "move"), l_(t) || o_(Cc.dirname(t)), u_(e, t, r, a);
}
function l_(e) {
...
function x_(e, t) {
  ...
  for (c = 1; c <= t.linesBefore && !(s - c < 0); c++)
    l = Ho(
      ...
      p
    ), o = ki.repeat(" ", t.indent) + Vo((e.line - c + 1).toString(), u) + " | " + l.str + `
` + o;
  for (l = Ho(e.buffer, r[s], i[s], e.position, p), o += ki.repeat(" ", t.indent) + Vo((e.line + 1).toString(), u) + " | " + l.str + `
...
var Qh = Ic, A_ = pt, Zh = new A_("tag:yaml.org,2002:str", {
  kind: "scalar",
...
}), Xn = Dt, yv = fa, $E = w_, SE = Ol, Dn = Object.prototype.hasOwnProperty, bs = 1, bv = 2, xv = 3, xs = 4, Wo = 1, TE = 2, gd = 3, AE = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, RE = /[\x85\u2028\u2029]/, PE = /[,\[\]\{\}]/, wv = /^(?:!|!!|![a-z\-]+!)$/i, _v = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function yd(e) {
...
function DE(e, t, n) {
  ...
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; f !== 0; ) {
    if (f === 58) {
      ...
      if (e.position === e.lineStart && Hs(e) || n && Cr(f))
        break;
      if (Vt(f))
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = i = e.position; (n = e.input.charCodeAt(e.position)) !== 0; )
    if (n === 39)
      if (Nn(e, r, e.position, !0), n = e.input.charCodeAt(++e.position), n === 39)
        ...
        return !0;
    else Vt(n) ? (Nn(e, r, i, !0), Cl(e, Ie(e, !1, t)), r = i = e.position) : e.position === e.lineStart && Hs(e) ? te(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function FE(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = r = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      ...
      n = r = e.position;
    } else Vt(o) ? (Nn(e, n, r, !0), Cl(e, Ie(e, !1, t)), n = r = e.position) : e.position === e.lineStart && Hs(e) ? te(e, "unexpected end of the document within a double quoted scalar") : (e.position++, r = e.position);
  }
...
function UE(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; p !== 0; )
    if (p = e.input.charCodeAt(++e.position), p === 43 || p === 45)
      Wo === i ? i = p === 43 ? gd : TE : te(e, "repeat of a chomping mode identifier");
    else if ((u = CE(p)) >= 0)
...
function HE(e) {
  ...
  if (Ie(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, Ie(e, !0, -1)) : a && te(e, "directives end mark is expected"), Wr(e, e.lineIndent - 1, xs, !1, !0), Ie(e, !0, -1), e.checkLineBreaks && RE.test(e.input.slice(t, e.position)) && ws(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Hs(e)) {
...
Rl.loadAll = VE;
Rl.load = GE;
var Av = {}, Vs = Dt, ma = fa, WE = Ol, Rv = Object.prototype.toString, Pv = Object.prototype.hasOwnProperty, Il = 65279, KE = 9, Zi = 10, YE = 13, XE = 32, JE = 33, QE = 34, kc = 35, ZE = 37, e$ = 38, t$ = 39, n$ = 42, Ov = 44, r$ = 45, _s = 58, i$ = 61, a$ = 62, s$ = 63, o$ = 64, Nv = 91, Cv = 93, c$ = 96, Iv = 123, l$ = 124, kv = 125, rt = {};
rt[0] = "\\0";
rt[7] = "\\a";
rt[8] = "\\b";
rt[9] = "\\t";
...
function f$(e) {
  ...
  return "\\" + n + Vs.repeat("0", r - t.length) + t;
}
var m$ = 1, ea = 2;
function h$(e) {
...
function Ed(e, t) {
  for (var n = Vs.repeat(" ", t), r = 0, i = -1, a = "", s, o = e.length; r < o; )
    i = e.indexOf(`
...
function Sd(e, t, n) {
  ...
  return (
    ...
    (n ? (
      // c = flow-in
      r
    ) : r && e !== Ov && e !== Nv && e !== Cv && e !== Iv && e !== kv) && e !== kc && !(t === _s && !i) || $d(t) && !Es(t) && e === kc || t === _s && i
  );
}
function g$(e) {
  return ta(e) && e !== Il && !Es(e) && e !== r$ && e !== s$ && e !== _s && e !== Ov && e !== Nv && e !== Cv && e !== Iv && e !== kv && e !== kc && e !== e$ && e !== n$ && e !== JE && e !== l$ && e !== i$ && e !== a$ && e !== t$ && e !== QE && e !== ZE && e !== o$ && e !== c$;
}
function y$(e) {
  return !Es(e) && e !== _s;
}
...
function b$(e, t, n, r, i, a, s, o) {
  ...
  return !p && !d ? b && !s && !i(e) ? jv : a === ea ? Or : jc : n > 9 && Dv(e) ? Or : s ? a === ea ? Or : jc : d ? Lv : Fv;
}
function x$(e, t, n, r, i) {
  e.dump = function() {
    if (t.length === 0)
...
function Pd(e, t, n, r) {
  ...
  for (s = 0, o = n.length; s < o; s += 1)
    c = n[s], e.replacer && (c = e.replacer.call(n, String(s), c)), (rn(e, t + 1, c, !0, !0, !1, !0) || typeof c > "u" && rn(e, t + 1, null, !0, !0, !1, !0)) && ((!r || i !== "") && (i += Dc(e, t)), e.dump && Zi === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function $$(e, t, n) {
...
function S$(e, t, n, r) {
  ...
  for (o = 0, c = s.length; o < c; o += 1)
    d = "", (!r || i !== "") && (d += Dc(e, t)), l = s[o], u = n[l], e.replacer && (u = e.replacer.call(n, l, u)), rn(e, t + 1, l, !0, !0, !0) && (p = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, p && (e.dump && Zi === e.dump.charCodeAt(0) ? d += "?" : d += "? "), d += e.dump, p && (d += Dc(e, t)), rn(e, t + 1, u, !0, p) && (e.dump && Zi === e.dump.charCodeAt(0) ? d += ":" : d += ": ", d += e.dump, i += d));
  e.tag = a, e.dump = i || "{}";
}
function Od(e, t, n) {
  var r, i, a, s, o, c;
...
const qa = Ks, { MAX_LENGTH: Cd, MAX_SAFE_INTEGER: Ba } = Ws, { safeRe: Id, t: kd } = ha, M$ = Dl, { compareIdentifiers: Er } = Bv;
let q$ = class Mt {
  constructor(t, n) {
...
var Ul = jS;
const FS = zv, LS = Hv, US = Ys, MS = Ll, qS = Fl, BS = Ul, zS = (e, t, n, r) => {
  switch (t) {
    case "===":
...
function Ft() {
  ...
  Ko = t;
  const n = YS, r = new n(), i = Dl, a = Xs(), s = Ks, o = dt, {
    safeRe: c,
    t: l,
    comparatorTrimReplace: u,
    tildeTrimReplace: p,
    caretTrimReplace: d
  } = ha, { FLAG_INCLUDE_PRERELEASE: f, FLAG_LOOSE: h } = Ws, b = (D) => D.value === "<0.0.0-0", v = (D) => D.value === "", g = (D, j) => {
    let G = !0;
    const N = D.slice();
    let B = N.pop();
    for (; G && N.length; )
...
function Xs() {
  ...
  Yo = t;
  const n = Dl, { safeRe: r, t: i } = ha, a = Vv, s = Ks, o = dt, c = Ft();
  return Yo;
}
...
var c1 = o1;
const Xo = dt, l1 = Ft(), Bd = Ys, u1 = (e, t) => {
  e = new l1(e, t);
  let n = new Xo("0.0.0");
...
var m1 = f1;
const h1 = dt, Gv = Xs(), { ANY: v1 } = Gv, g1 = Ft(), y1 = Js, zd = Ys, Hd = Fl, b1 = Ul, x1 = Ll, w1 = (e, t, n, r) => {
...
const Gd = Ft(), ql = Xs(), { ANY: Jo } = ql, Ei = Js, Bl = jt, I1 = (e, t, n = {}) => {
  if (e === t)
    return !0;
...
var j1 = I1;
const Qo = ha, Xd = Ws, F1 = dt, Jd = Bv, L1 = Zr, U1 = V$, M1 = K$, q1 = X$, B1 = Q$, z1 = tS, H1 = iS, V1 = oS, G1 = uS, W1 = jt, K1 = mS, Y1 = gS, X1 = jl, J1 = wS, Q1 = $S, Z1 = Ys, eT = Fl, tT = zv, nT = Hv, rT = Ll, iT = Ul, aT = Vv, sT = WS, oT = Xs(), cT = Ft(), lT = Js, uT = e1, pT = i1, dT = c1, fT = p1, mT = m1, hT = Ml, vT = $1, gT = A1, yT = P1, bT = C1, xT = j1;
var zl = {
  parse: L1,
  valid: U1,
  clean: M1,
...
(function(e, t) {
  ...
  ), wp = ne ? m.Buffer : void 0, Ra = m.Symbol, _p = m.Uint8Array, Ep = pn.propertyIsEnumerable, Jy = ui.splice, Bn = Ra ? Ra.toStringTag : void 0, $p = Object.getOwnPropertySymbols, Qy = wp ? wp.isBuffer : void 0, Zy = ci(Object.keys, Object), Po = xr(m, "DataView"), di = xr(m, "Map"), Oo = xr(m, "Promise"), No = xr(m, "Set"), Co = xr(m, "WeakMap"), fi = xr(Object, "create"), e0 = Vn(Po), t0 = Vn(di), n0 = Vn(Oo), r0 = Vn(No), i0 = Vn(Co), Sp = Ra ? Ra.prototype : void 0, Io = Sp ? Sp.valueOf : void 0;
  function zn(E) {
  ...
  function A0(E, P) {
    var W = Ca(E), Z = !W && B0(E), be = !W && !Z && ko(E), ae = !W && !Z && !be && kp(E), Ae = W || Z || be || ae, Fe = Ae ? it(E.length, String) : [], Be = Fe.length;
    for (var Se in E)
...
function KT(e, t, n) {
  ...
  return [Uc(`${e.pathname.replace(new RegExp(VT(n), "g"), t)}.blockmap`, e), r];
}
var qe = {};
...
const af = Me, ec = Rt, tc = qe;
class eA extends tc.Provider {
  constructor(t, n, r) {
...
eo.BitbucketProvider = void 0;
const sf = Me, nc = Rt, rc = qe;
class tA extends rc.Provider {
  constructor(t, n, r) {
    super({
      ...r,
  ...
  async getLatestVersion() {
    const t = new sf.CancellationToken(), n = (0, nc.getChannelFilename)(this.getCustomChannelName(this.channel)), r = (0, nc.newUrlFromBase)(n, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
eo.BitbucketProvider = tA;
var Fn = {};
Object.defineProperty(Fn, "__esModule", { value: !0 });
Fn.GitHubProvider = Fn.BaseGitHubProvider = void 0;
Fn.computeReleaseNotes = Qv;
const Qt = Me, kr = zl, nA = Gt, Dr = Rt, Mc = qe, ic = /\/tag\/([^/]+)$/;
class Jv extends Mc.Provider {
  constructor(t, n, r) {
    super({
      ...r,
...
to.KeygenProvider = void 0;
const cf = Me, ac = Rt, sc = qe;
class iA extends sc.Provider {
  constructor(t, n, r) {
    super({
      ...r,
      isUseMultipleRangeRequest: !1
  ...
  async getLatestVersion() {
    const t = new cf.CancellationToken(), n = (0, ac.getChannelFilename)(this.getCustomChannelName(this.channel)), r = (0, ac.newUrlFromBase)(n, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
to.KeygenProvider = iA;
var no = {};
Object.defineProperty(no, "__esModule", { value: !0 });
no.PrivateGitHubProvider = void 0;
...
no.PrivateGitHubProvider = lA;
Object.defineProperty(Zs, "__esModule", { value: !0 });
Zs.isUrlProbablySupportMultiRangeRequests = Zv;
Zs.createClient = mA;
const Va = Me, uA = eo, pf = ga, pA = Fn, dA = to, fA = no;
function Zv(e) {
...
io.executeTasksUsingMultipleRangeRequests = _A;
io.checkIsRangesSupported = Bc;
const qc = Me, hf = ei, vf = gr;
...
ao.ProgressDifferentialDownloadCallbackTransform = void 0;
const $A = Ve;
var jr;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
...
ao.ProgressDifferentialDownloadCallbackTransform = SA;
Object.defineProperty(ya, "__esModule", { value: !0 });
ya.DifferentialDownloader = void 0;
const $i = Me, oc = Un, TA = Ee, AA = ei, RA = Gt, Wa = gr, gf = io, PA = ao;
class OA {
...
ro.GenericDifferentialDownloader = void 0;
const CA = ya;
...
ro.GenericDifferentialDownloader = IA;
var bf;
function Vl() {
  if (bf) return Wn;
  bf = 1, Object.defineProperty(Wn, "__esModule", { value: !0 }), Wn.NoOpLogger = Wn.AppUpdater = void 0;
  const e = Me, t = Xr, n = ca, r = Ym, i = Un, a = Ye, s = Gs, o = pe, c = zl, l = va, u = Qs, p = Wv, d = ga, f = ti(), h = Zs, b = Ht, v = Rt, g = ro;
...
function _f() {
  ...
  const e = Me, t = Ds, n = Un, r = Ee, i = pe, a = ba(), s = xa, o = ti(), c = qe;
...
function Rf() {
  ...
  const e = Me, t = Un, n = Ee, r = pe, i = js, a = Vl(), s = qe, o = Ds, c = Xr;
...
const BA = "dotenv", zA = "16.4.5", HA = "Loads environment variables from .env file", VA = "lib/main.js", GA = "lib/main.d.ts", WA = {
  ...
  engines: tR,
  browser: nR
}, zc = Ee, Wl = pe, iR = ca, aR = Xr, sR = rR, Kl = sR.version, oR = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
function cR(e) {
  const t = {};
  let n = e.toString();
  n = n.replace(/\r\n?/mg, `
...
function mR(e) {
  ...
  for (const c of i)
    try {
      const l = je.parse(zc.readFileSync(c, { encoding: n }));
      je.populate(s, l, e);
    } catch (l) {
...
const { toString: xR } = Object.prototype, { getPrototypeOf: Yl } = Object, so = /* @__PURE__ */ ((e) => (t) => {
  const n = xR.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), Lt = (e) => (e = e.toLowerCase(), (t) => so(t) === e), oo = (e) => (t) => typeof t === e, { isArray: ni } = Array, na = oo("undefined");
function wR(e) {
...
const ER = oo("string"), xt = oo("function"), cg = oo("number"), co = (e) => e !== null && typeof e == "object", $R = (e) => e === !0 || e === !1, as = (e) => {
  if (so(e) !== "object")
    return !1;
  const t = Yl(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, SR = Lt("Date"), TR = Lt("File"), AR = Lt("Blob"), RR = Lt("FileList"), PR = (e) => co(e) && xt(e.pipe), OR = (e) => {
  let t;
  return e && (typeof FormData == "function" && e instanceof FormData || xt(e.append) && ((t = so(e)) === "formdata" || // detect form-data instance
...
function Hc() {
  const { caseless: e } = ug(this) && this || {}, t = {}, n = (r, i) => {
    const a = e && lg(t, i) || i;
    as(t[a]) && as(r) ? t[a] = Hc(t[a], r) : as(r) ? t[a] = Hc({}, r) : ni(r) ? t[a] = r.slice() : t[a] = r;
  };
...
}, QR = (e, t) => e != null && Number.isFinite(e = +e) ? e : t, lc = "abcdefghijklmnopqrstuvwxyz", jf = "0123456789", dg = {
  DIGIT: jf,
  ALPHA: lc,
  ALPHA_DIGIT: lc + lc.toUpperCase() + jf
...
const tP = (e) => {
  ...
  return n(e, 0);
}, nP = Lt("AsyncFunction"), rP = (e) => e && (co(e) || xt(e)) && xt(e.then) && xt(e.catch), fg = ((e, t) => e ? setImmediate : t ? ((n, r) => (nr.addEventListener("message", ({ source: i, data: a }) => {
...
var lo = { exports: {} }, Mf = wg, RP = _g, PP = Eg;
lo.exports = OP;
lo.exports.ascending = $g;
lo.exports.descending = NP;
function OP(e, t, n, r) {
  var i = RP(e, n);
...
}, Xl = cP, FP = mr, uc = pe, LP = js, UP = ml, MP = Gt.parse, qP = Ee, BP = Ve.Stream, pc = yg, zP = DP, Vc = jP, HP = fe;
FP.inherits(fe, Xl);
function fe(e) {
...
fe.prototype.submit = function(e, t) {
  ...
  return typeof e == "string" ? (e = MP(e), r = Vc({
    port: e.port,
    path: e.pathname,
    host: e.hostname,
    protocol: e.protocol
  }, i)) : (r = Vc(e, i), r.port || (r.port = r.protocol == "https:" ? 443 : 80)), r.headers = this.getHeaders(e.headers), r.protocol == "https:" ? n = UP.request(r) : n = LP.request(r), this.getLength((function(a, s) {
...
function uo(e, t, n) {
  ...
  function u(h, b, v) {
    ...
    return Gc(h) ? !0 : (t.append(qf(v, b, a), l(h)), !1);
  }
...
}, Zl = typeof window < "u" && typeof document < "u", Wc = typeof navigator == "object" && navigator || void 0, XP = Zl && (!Wc || ["ReactNative", "NativeScript", "NS"].indexOf(Wc.product) < 0), JP = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
...
function eO(e, t) {
  return uo(e, new Ue.classes.URLSearchParams(), Object.assign({
...
}, Ea = Gt, ra = Ea.URL, bO = js, xO = ml, nu = Ve.Writable, ru = fl, Cg = yO;
(function() {
...
vt.prototype._processResponse = function(e) {
  ...
  var s = mc(/^host$/i, this._options.headers), o = ou(this._currentUrl), c = s || o.host, l = /^\w+:/.test(n) ? this._currentUrl : Ea.format(Object.assign(o, { host: c })), u = TO(n, l);
  if (Cg("redirecting to", u.href), this._isRedirect = !0, Xc(u, this._options), (u.protocol !== o.protocol && u.protocol !== "https:" || u.host !== c && !AO(u.host, c)) && mc(/^(?:(?:proxy-)?authorization|cookie)$/i, this._options.headers), cr(i)) {
    var p = {
      headers: e.headers,
      statusCode: t
    }, d = {
...
function Ig(e) {
  ...
  return Object.keys(e).forEach(function(r) {
    ...
    function o(l, u, p) {
      return PO(l) ? l = Xc(l) : ar(l) ? l = Xc(ou(l)) : (p = u, u = Dg(l), l = { protocol: i }), cr(u) && (p = u, u = null), u = Object.assign({
...
const KO = typeof process < "u" && C.kindOf(process) === "process", YO = (e) => new Promise((t, n) => {
  ...
  return YO(async function(r, i, a) {
    ...
    if (D.agent = G ? t.httpsAgent : t.httpAgent, t.transport ? j = t.transport : t.maxRedirects === 0 ? j = G ? ml : js : (t.maxRedirects && (D.maxRedirects = t.maxRedirects), t.beforeRedirect && (D.beforeRedirects.config = t.beforeRedirect), j = G ? VO : HO), t.maxBodyLength > -1 ? D.maxBodyLength = t.maxBodyLength : D.maxBodyLength = 1 / 0, t.insecureHTTPParser && (D.insecureHTTPParser = t.insecureHTTPParser), h = j.request(D, function(B) {
...
const Ug = (e) => {
...
}, po = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", Mg = po && typeof ReadableStream == "function", sN = po && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), qg = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return !1;
  ...
  return e && !t;
}), em = 64 * 1024, Jc = Mg && qg(() => C.isReadableStream(new Response("").body)), Ps = {
  stream: Jc && ((e) => e.body)
};
po && ((e) => {
...
const tm = (e) => `- ${e}`, pN = (e) => C.isFunction(e) || e === null || e === !1, Bg = {
  getAdapter: (e) => {
    ...
    for (let a = 0; a < t; a++) {
      n = e[a];
      let s;
      if (r = n, !pN(n) && (r = Qc[(s = String(n)).toLowerCase()], r === void 0))
...
function nm(e) {
  return vc(e), e.headers = Ke.from(e.headers), e.data = fc.call(
    e,
    e.transformRequest
    ...
    return Ng(r) || (vc(e), r && r.response && (r.response.data = fc.call(
      e,
      e.transformResponse,
      r.response
...
le.mergeConfig = lr;
le.AxiosHeaders = Ke;
le.formToJSON = (e) => Og(C.isHTMLForm(e) ? new FormData(e) : e);
le.getAdapter = Bg.getAdapter;
le.HttpStatusCode = el;
le.default = le;
const pu = "auth";
me.handle(`${pu}-sign-up`, async (e, t) => ({ message: "Data saved", data: t }));
...
const du = "user";
me.handle(`${du}-update`, async (e, t) => (await le.put(
...
me.handle(`${du}-delete`, async (e, t) => (await le.delete(
...
me.handle(`${fo}-add`, async (e, t) => (await le.post(
...
me.handle(`${fo}-delete`, async (e, t) => (await le.delete(
...
const Sn = Fs.homedir(), mu = Fs.tmpdir(), { env: Ur } = De, bN = (e) => {
...
const TN = new SN(), yn = (e, t) => function(r) {
  ...
  attempt: {
    /* ASYNC */
    chmod: gn(Je(oe.chmod), _e.onChangeError),
    chown: gn(Je(oe.chown), _e.onChangeError),
    close: gn(Je(oe.close), yt),
    fsync: gn(Je(oe.fsync), yt),
    mkdir: gn(Je(oe.mkdir), yt),
    realpath: gn(Je(oe.realpath), yt),
    stat: gn(Je(oe.stat), yt),
    unlink: gn(Je(oe.unlink), yt),
    /* SYNC */
    chmodSync: Jt(oe.chmodSync, _e.onChangeError),
    chownSync: Jt(oe.chownSync, _e.onChangeError),
    closeSync: Jt(oe.closeSync, yt),
    existsSync: Jt(oe.existsSync, yt),
    fsyncSync: Jt(oe.fsync, yt),
    mkdirSync: Jt(oe.mkdirSync, yt),
    realpathSync: Jt(oe.realpathSync, yt),
    statSync: Jt(oe.statSync, yt),
    unlinkSync: Jt(oe.unlinkSync, yt)
  },
  retry: {
    /* ASYNC */
    close: yn(Je(oe.close), _e.isRetriableError),
    fsync: yn(Je(oe.fsync), _e.isRetriableError),
    open: yn(Je(oe.open), _e.isRetriableError),
    readFile: yn(Je(oe.readFile), _e.isRetriableError),
    rename: yn(Je(oe.rename), _e.isRetriableError),
    stat: yn(Je(oe.stat), _e.isRetriableError),
    write: yn(Je(oe.write), _e.isRetriableError),
    writeFile: yn(Je(oe.writeFile), _e.isRetriableError),
    /* SYNC */
...
}, AN = "utf8", am = 438, RN = 511, PN = {}, ON = Fs.userInfo().uid, NN = Fs.userInfo().gid, CN = 1e3, IN = !!De.getuid;
De.getuid && De.getuid();
const sm = 128, kN = (e) => e instanceof Error && "code" in e, om = (e) => typeof e == "string", yc = (e) => e === void 0, DN = De.platform === "linux", Vg = De.platform === "win32", hu = ["SIGABRT", "SIGALRM", "SIGHUP", "SIGINT", "SIGTERM"];
...
var tl = { exports: {} }, vu = {}, At = {}, Yr = {}, Ta = {}, ie = {}, aa = {};
(function(e) {
...
function WC(e, t = !0) {
  return typeof e == "boolean" ? !0 : t === !0 ? !al(e) : t ? uy(e) <= t : !1;
}
Ge.inlineRef = WC;
...
const fy = Yr, dm = ke, $u = tn, Os = ke, ZC = vo, Bi = Bt, bc = Cn, ee = ie, re = wt, eI = Ge, nn = X, Ci = Ta;
function tI(e) {
  if (vy(e) && (gy(e), hy(e))) {
    iI(e);
    return;
...
function TI(e, t, n) {
  ...
  if (a === void 0) {
    ...
    s && (a = new go({ schema: s, schemaId: o, root: e, baseId: t }));
  }
  if (a !== void 0)
...
function PI(e, t) {
  ...
  for (; typeof (n = this.refs[t]) == "string"; )
    t = n;
  return n || this.schemas[t] || yo.call(this, e, t);
}
function yo(e, t) {
  ...
  if (typeof (s == null ? void 0 : s.schema) == "object") {
    if (s.validate || Tu.call(this, s), a === (0, It.normalizeId)(t)) {
      ...
      return l && (i = (0, It.resolveUrl)(this.opts.uriResolver, i, l)), new go({ schema: o, schemaId: c, root: e, baseId: i });
    }
...
function wc(e, { baseId: t, schema: n, root: r }) {
  ...
  if (a = a || new go({ schema: n, schemaId: s, root: r, baseId: t }), a.schema !== a.root.schema)
    return a;
}
...
bo.exports = Ou;
bo.exports.default = Ou;
bo.exports.fastUri = Ou;
var vk = bo.exports;
...
const _c = ke, ze = ie, qk = X, Bk = Aa, zk = {
...
const ol = ie, Vk = X, Gk = Aa, Wk = {
  ...
  code(e) {
    ...
    r || a && typeof a == "object" ? e.fail$data((0, ol._)`!${(0, Vk.useFunc)(t, Gk.default)}(${n}, ${i})`) : e.fail((0, ol._)`${a} !== ${n}`);
  }
};
Bu.default = Kk;
var zu = {};
...
const VD = ii, GD = Hu, WD = ai, KD = Vu, YD = Gu, XD = Eo, JD = Wu, QD = $o, ZD = Ku, ej = Yu, tj = Xu, nj = Ju, rj = Qu, ij = Zu, aj = ep, sj = tp;
function oj(e = !1) {
  const t = [
    // any
    tj.default,
...
const $c = ie, cj = wt, Om = st, lj = on, uj = {
...
function qy(e, t) {
  ...
  const i = (0, $c._)`${cj.default.dynamicAnchors}${(0, $c.getProperty)(t)}`, a = r.errSchemaPath === "#" ? r.validateName : pj(e);
...
const Vj = xo, Gj = wo, Wj = _o, Kj = np, Yj = ap, Xj = lp, Jj = So, jm = dr, Qj = [
  Kj.default,
  Vj.default,
  Gj.default,
  (0, Wj.default)(!0),
...
var To = {}, Ao = {};
Object.defineProperty(Ao, "__esModule", { value: !0 });
Ao.DiscrError = void 0;
var Fm;
(function(e) {
  e.Tag = "tag", e.Mapping = "mapping";
})(Fm || (Ao.DiscrError = Fm = {}));
Object.defineProperty(To, "__esModule", { value: !0 });
const Nr = ie, ll = Ao, Lm = st, Zj = yr, eF = X, tF = {
...
(function(e, t) {
  ...
  const n = vu, r = Nu, i = To, a = fp, s = "https://json-schema.org/draft/2020-12/schema";
...
var R2 = tl.exports, ul = { exports: {} }, zy = {};
(function(e) {
...
var Hy = {}, pl = { exports: {} }, mp = {};
Object.defineProperty(mp, "__esModule", { value: !0 });
const P2 = xo, O2 = wo, N2 = _o, C2 = So, Um = dr, I2 = [
  P2.default,
  O2.default,
  (0, N2.default)(),
  C2.default,
...
(function(e, t) {
  ...
  const n = vu, r = mp, i = To, a = M2, s = ["/properties"], o = "http://json-schema.org/draft-07/schema";
...
}, ds = "__internal__", Tc = `${ds}.migrations.version`;
var Tn, Zt, bt, en;
class uL {
  constructor(t = {}) {
    vi(this, "path");
  ...
  get store() {
    try {
      const t = oe.readFileSync(this.path, we(this, Zt) ? null : "utf8"), n = this._encryptData(t), r = this._deserialize(n);
  ...
  *[Symbol.iterator]() {
  ...
  _encryptData(t) {
    ...
    try {
      const n = t.slice(0, 16), r = bi.pbkdf2Sync(we(this, Zt), n.toString(), 1e4, 32, "sha512"), i = bi.createDecipheriv(zm, r, n), a = t.slice(17), s = typeof a == "string" ? Sc(a) : a;
  ...
  _write(t) {
    ...
    if (we(this, Zt)) {
      ...
      n = qm([r, Sc(":"), a.update(Sc(n)), a.final()]);
    }
    if (De.env.SNAP)
  ...
  _watch() {
    this._ensureDirectory(), oe.existsSync(this.path) || this._write(Pr()), De.platform === "win32" ? oe.watch(this.path, { persistent: !1 }, Mm(() => {
      this.events.dispatchEvent(new Event("change"));
    }, { wait: 100 })) : oe.watchFile(this.path, { persistent: !1 }, Mm(() => {
      this.events.dispatchEvent(new Event("change"));
    }, { wait: 5e3 }));
  }
  _migrate(t, n, r) {
...
class hp extends uL {
  ...
  async openInEditor() {
    const t = await dl.openPath(this.path);
    if (t)
      throw new Error(t);
  }
}
...
const mL = process.env.NODE_ENV === "production" ? ".env.production" : ".env.development";
bR.config({ path: mL });
const sa = ce.dirname(tb(import.meta.url));
process.env.APP_ROOT = ce.join(sa, "..");
const oa = process.env.VITE_DEV_SERVER_URL, KL = ce.join(process.env.APP_ROOT, "dist-electron"), yp = ce.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = oa ? ce.join(process.env.APP_ROOT, "public") : yp;
let Ce, He;
function Yy() {
  Ce = new fr({
    title: "PatientCare",
  ...
  }), oa ? Ce.loadURL(oa) : Ce.loadFile(ce.join(yp, "index.html"));
}
function hL() {
  He = new fr({
  ...
  }), oa ? He.loadURL(`${oa}/updater.html`) : He.loadFile(ce.join(yp, "updater.html")), He.once("ready-to-show", () => {
    He == null || He.show(), an.autoUpdater.checkForUpdates(), Ro({
      status: "checking",
